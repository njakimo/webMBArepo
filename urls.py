...
urlpatterns = patterns('',
    ...
    (r'^seriesbrowser/showOnlyNissl/(?P<id>\d+)/(?P<sectionId>\d+)/$', 'seriesbrowser.views.showOnlyNissl'),
    (r'^seriesbrowser/downloadPDF/(?P<id>\d+)/$', 'seriesbrowser.views.downloadPDF'),
