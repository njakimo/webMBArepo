...
urlpatterns = patterns('',
    ...
    (r'^seriesbrowser/allSections/$', 'seriesbrowser.views.allSections'),
    (r'^seriesbrowser/allSections/showNissl/$', 'seriesbrowser.views.showNisslAllSections'),
    (r'^seriesbrowser/ajax/section/(?P<id>\d+)/$', 'seriesbrowser.views.section'),
    (r'^seriesbrowser/ajax/section/showNissl/(?P<id>\d+)/$', 'seriesbrowser.views.showNissl'),
    (r'^seriesbrowser/ajax/section/addNote/(?P<id>\d+)/$', 'seriesbrowser.views.addNote'),
